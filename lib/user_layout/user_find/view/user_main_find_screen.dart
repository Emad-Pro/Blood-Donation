...
import 'package:blood_donation/user_layout/user_find/view_model/cubit/user_find_hospital_cubit.dart';
      ...
      builder: (context, state) {
        ...
        switch (state.hospitalsState) {
          ...
          case RequestState.success:
            return UserMainFindBody(state: state);
...
class UserMainFindBody extends StatelessWidget {
  const UserMainFindBody({Key? key, required this.state}) : super(key: key);
  final UserFindHospitalState state;
  @override
  Widget build(BuildContext context) {
                  ...
                  child: Row(
                    children: [
                      ...
                      if (state.selectedGovernorate != null)
                        IconButton(
                          onPressed: () {
                            getIt<UserFindHospitalCubit>().cleargovernorates();
                          },
                          icon: Icon(
                            Icons.clear,
                            color: Theme.of(context).colorScheme.primary,
                    ...
                    children: [
                      Expanded(
                        child: DropdownButton<String>(
                          ...
                          onChanged: (newValue) {
                            getIt<UserFindHospitalCubit>().toggleDay(newValue!);
                          },
                        ),
                      ),
                      if (state.selectedDay != null)
                        IconButton(
                          onPressed: () {
                            getIt<UserFindHospitalCubit>().clearDayWorking();
                          },
                          icon: Icon(
                            Icons.clear,
                            color: Theme.of(context).colorScheme.primary,
